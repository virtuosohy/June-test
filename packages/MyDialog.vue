<template>
  <transition name="dialog-fade">
    ...
    <div class="d-dialog_wrapper" v-show="visiable" @click.self="closeDialog">
      <div :class="['d-dialog', mimicry ? 'is-mimicry' : '']" :style="{ width: width, 'margin-top': top }">
        <div class="d-dialog_header">
          <!-- title支持slot插槽 -->
          <slot name="title">
            <span class="d-dialog_title">{{ title }}</span>
          </slot>
          <d-button circle :icon="['far', 'times-circle']" class="d-dialog_headerbtn" @click="closeDialog"></d-button>
        </div>
